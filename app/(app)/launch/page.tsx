...
export default async function LaunchPage() {
  ...
  const { data: clients } = await supabase
    .from("clients")
    .select(
      "id, name, industry, marine_business_type, meta_ad_account_id, meta_page_id, landing_page_url, location_description, market_name, season_type, current_promotion, business_type_description, offer_description, tone_keywords",
    )
    .eq("archived", false)
    .order("name");
